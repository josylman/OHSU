...
F_scan <- as.matrix(read.xlsx("20160701.xlsx", sheetIndex=1, header = TRUE))
FF_1 <- as.matrix(read.xlsx("20160701.xlsx", sheetIndex=1, header = TRUE))
...
# default operation)
bgrd <- apply(FF_1[3:nrow(FF_1),],1,max) # Finds the minimum in each row
